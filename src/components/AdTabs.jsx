...
// import { setAd } from '../store/slices/adSlice';
...
//     try {
//         const response = await axios.post('http://localhost:5000/api/create_post', formData, {
//             headers: {
...
//       {!selectedItem && !showImageUploadModal  ? (
//         <>
//          <h2 className="offering-title">What are you offering?</h2>
//           <div className="tabs">
//             <span className={`tab ${activeTab === 'renting' ? 'active' : ''}`} onClick={() => setActiveTab('renting')}>
//               Renting
//             </span>
...
//         />
//       ):
//       <ImageUploadForm adId={currentPostId} onClose={() => setShowImageUploadModal(false)}/>}
